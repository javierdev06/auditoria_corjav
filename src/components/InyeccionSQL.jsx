...
function DemoSQL() {
  ...
  return (
    <div style={demoWrap}>
      ...
      <p style={{ margin: '0 0 12px', color: '#374151', lineHeight: 1.6 }}>Reproduce el ataque con la misma entrada usada en DVWA. Es una simulación controlada: no se ejecuta nada real sobre este sitio.</p>
